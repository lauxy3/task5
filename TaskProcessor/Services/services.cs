...
public class services : BackgroundService
{
    ...
    public services(ILoggerFactory loggerFactory, IConfiguration env, IServiceScopeFactory scopeFactory)
    {
        _scopeFactory = scopeFactory;
        this._logger = loggerFactory.CreateLogger<services>();
        // _context = context;
        _env = env;
        InitRabbitMQ();
    }
    ...
    private void HandleMessage(string content)
    {
        ...
        TaskProcessorItem taskProcessItem = JsonSerializer.Deserialize<TaskProcessorItem>(content);
